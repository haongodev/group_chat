    ...
    public function getQueryBuilderBySearchData($searchData)
    {
        ...
        if (!empty($searchData['customer_id']) && $searchData['customer_id']) {
            $qb
                ...
                ->setParameter('ids', $searchData['customer_id']);
        }
        ...
        if (!empty($searchData['delete_at']) && $searchData['delete_at'] == 'is_null') {
            $qb
                ->andWhere('c.delete_at is null');
        }

        if (!empty($searchData['member_type'])) {
            $qb
                ->andWhere('c.member_type = :member_type')
                ->setParameter('member_type', $searchData['member_type']);
        }

        if (!empty($searchData['parent_id']) && $searchData['parent_id'] > 0) {
            $qb
                ->andWhere('c.parent_id = :parent_id')
                ->setParameter('parent_id', $searchData['parent_id']);
        }
