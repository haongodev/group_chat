...
if (!class_exists('\Eccube\Entity\Customer')) {
     ...
     * Customer
     *
     * @ORM\Table(name="dtb_customer", uniqueConstraints={@ORM\UniqueConstraint(name="secret_key", columns={"secret_key"})}, indexes={@ORM\Index(name="dtb_customer_buy_times_idx", columns={"buy_times"}), @ORM\Index(name="dtb_customer_buy_total_idx", columns={"buy_total"}), @ORM\Index(name="dtb_customer_create_date_idx", columns={"create_date"}), @ORM\Index(name="dtb_customer_update_date_idx", columns={"update_date"}), @ORM\Index(name="dtb_customer_last_buy_date_idx", columns={"last_buy_date"}), @ORM\Index(name="dtb_customer_email_idx", columns={"email"}), @ORM\Index(name="IDX_customer_parent_id", columns={"parent_id"})})
    ...
    class Customer extends \Eccube\Entity\AbstractEntity implements UserInterface
    {
         ...
         * @var int
         *
         * @ORM\Column(name="limit_storage", type="integer")
         */
        private $limit_storage;
        /**
         * Constructor
         */
         ...
         * @return Customer
         */
        public function setStorageLimit($Capacity)
        {
            $this->limit_storage = $Capacity;
